...
title: "Stonks"
date: "April-2024"
description: "Stonks is a beginner-friendly 👋 stock information app that revolutionizes the way you access and understand stock data. Built on Streamlit 💻, it leverages serverless Cloudflare Workers ☁️ and Workers AI 🤖 to generate insightful stock summaries from polygon.io API 📊, handling over 1,000 queries daily."
image: "https://res.cloudinary.com/rony-personal/image/upload/v1716993138/projects/stonks.jpg"
tech:
    - "Streamlit"
    - "Cloudflare Workers"
    - "Workers AI"
